...
const int NUM_TOKENIDS = 98;	    // number of token id strings in the list
const int FIRST_TOK_RESWD_NDX = 8;  // index of the first reserved word/symbol in the list
const int LAST_TOK_RESWD_NDX = 78;  // index of the last  reserved word/symbol in the list
const int FIRST_NON_TERMINAL = 79;  // index of the first Non-Terminal Token Id
